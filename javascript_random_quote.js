...
var authorBox= document.getElementById("random-quote-author");
...
document.getElementById("new-quote").addEventListener("click", function() {
  var random = Math.round(Math.random() * (myQuotes.length - 1));
 quoteBox.innerHTML = "";
  quoteBox.innerHTML +=  myQuotes[random].quote.toString();
  document.getElementById("random-quote-author").innerHTML = "-"+ myQuotes[random].author;
$('#tweeter').attr("href", 'https://twitter.com/intent/tweet?text=' + myQuotes[random].quote)});